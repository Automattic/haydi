 ...
 *
 * Security model:
 *  - Every action verifies WordPress's edit_plugins code-execution floor, the
 *    configured Haydi access capability, AND a nonce (handled by
 *    Haydi_Ajax_Tool_Base::verify).
